...
export const metadata: Metadata = {
  title: 'Kitchora • Smart Tools. Better Kitchens.',
  description: 'India’s kitchen specialist for smart prep tools, airtight storage, cookware, tri-ply tawas and pantry organizers.',
};
